"""
mediator e um padrao de projeto comportamental que tem a intencao de definir um objeto que encapsula a forma como um conjunto de objetos interage. o mediator promove o baixo acoplamento ao evitar que os objetos se refiram uns aos outros explicitamente e permite variar suas interacoes independentemente
"""

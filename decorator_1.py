...
class SpecialHotgod(Hotdog):
    def __init__(self) -> None:
        self._name:str = "specialhotdog"
        self._ingredients:List[Ingredient] = [Bread(),Sausage(),PotatoSticks(),Bacon(),Egg(),Cheese(),MashedPotatoes()]
...
if __name__ == "__main__":
    ...
    decorated_simple_hotdog = HotdogDecorator(simple_hot_dog)
    bacon_simple_hotdog = BaconDecorator(simple_hot_dog)
